...
def main(unused_argv):
  ...
  # train_data, y_train = load_mnist('data/fashion', kind='train')
  # eval_data, y_test = load_mnist('data/fashion', kind='t10k')

  # train_labels = np.zeros((y_train.size, 10)).astype(np.float32)
  # train_labels[np.arange(y_train.size), y_train] = 1

  # eval_labels = np.zeros((y_test.size, 10)).astype(np.float32)
  # eval_labels[np.arange(y_test.size), y_test] = 1
